...
public static class L
{
    ...
    {        ["section.drive"]    = ["Unidad", "Drive", "Unidade", "Lecteur", "Unità"],
        ...
        ["update.unverifiable"]   = ["El instalador descargado no se pudo verificar: no está firmado y la versión no publica su hash SHA-256. Se ha descartado por seguridad. Descarga la actualización manualmente desde la página del proyecto en GitHub.", "The downloaded installer could not be verified: it is not signed and the release does not publish its SHA-256 hash. It was discarded for safety. Download the update manually from the project page on GitHub.", "Não foi possível verificar o instalador baixado: não está assinado e a versão não publica o seu hash SHA-256. Foi descartado por segurança. Baixe a atualização manualmente na página do projeto no GitHub.", "L'installateur téléchargé n'a pas pu être vérifié : il n'est pas signé et la version ne publie pas son empreinte SHA-256. Il a été supprimé par sécurité. Téléchargez la mise à jour manuellement depuis la page du projet sur GitHub.", "Non è stato possibile verificare il programma di installazione scaricato: non è firmato e la versione non pubblica il suo hash SHA-256. È stato scartato per sicurezza. Scarica l'aggiornamento manualmente dalla pagina del progetto su GitHub."],
