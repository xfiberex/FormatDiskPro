...
- **Panel de rendimiento** en el pie: **Disco** (velocidad de la operación en curso y su **pico**), **CPU** y **RAM** del equipo, con barras que siguen los mismos umbrales de color que la barra de ocupación. Se despliega solo al empezar una operación y se queda con el pico al terminar, a modo de resumen; plegado deja un resumen de una línea, y solo muestrea cuando está abierto o hay algo corriendo. El caudal sale de los bytes que **la propia operación** reporta, no de un contador del sistema
