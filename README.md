...
### Diagnóstico
- **Panel de información jerárquico**: la **capacidad** como dato principal y la **salud** a su derecha con un punto de color (las dos preguntas que se hacen al elegir una unidad), con sistema de archivos, tipo y conexión en una línea de contexto; y una **barra de ocupación de dos colores** —espacio usado y espacio libre, cada uno con el suyo, con el dato en claro sobre ella (`Usado 780,9 GB / 930,5 GB`)— cuyo relleno indica además lo llena que está la unidad (neutro con espacio de sobra, **ámbar** al llenarse ≥80 % y **rojo** casi llena ≥90 %), nunca el color de acento del sistema
...
- **Franja de rendimiento** en el pie, siempre visible y en una sola línea: **Disco** (velocidad de la operación en curso), **CPU** y **RAM** del equipo, con barras que siguen los mismos umbrales de color que la barra de ocupación. El detalle de cada una —el **pico** alcanzado, los núcleos, lo que consume la app— está en su tooltip. El caudal sale de los bytes que **la propia operación** reporta, no de un contador del sistema, y solo se muestrea con la ventana al frente o con algo corriendo
